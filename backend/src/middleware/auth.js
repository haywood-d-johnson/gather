...
exports.checkHouseholdAccess = exports.authenticateUser = void 0;
...
const checkHouseholdAccess = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const householdId = req.params.householdId || req.body.householdId;
        if (!householdId) {
            return res.status(400).json({ error: 'Household ID required' });
        }
        const user = yield firebaseService.getUserById(req.user.uid);
...
exports.checkHouseholdAccess = checkHouseholdAccess;
